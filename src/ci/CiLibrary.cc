...
void
CiLibrary::set_technology(CellTechnology technology)
{
...
// @brief 遅延モデルを設定する．
void
CiLibrary::set_delay_model(CellDelayModel delay_model)
{
...
CiLibrary::restore(IDO& s)
{
  ...
  s >> tmp1
    >> tmp2;
  CellTechnology technology = static_cast<CellTechnology>(tmp1);
  CellDelayModel delay_model = static_cast<CellDelayModel>(tmp2);
  ...
  for (ymuint cell_id = 0; cell_id < nc; ++ cell_id) {
	...
	>> tmp
	>> cond;
      CellTimingType timing_type = static_cast<CellTimingType>(tmp);
				...
				ymuint id)
{
  ...
  case 1:
    {
      ymuint8 tmp;
      s >> tmp;
      CellVarType var_type = static_cast<CellVarType>(tmp);
      ymuint8 n;
      s >> n;
  ...
  case 2:
    {
      ymuint8 tmp1;
      s >> tmp1;
      CellVarType var_type1 = static_cast<CellVarType>(tmp1);
      ymuint8 n1;
      s >> n1;
	...
	index_array1[i] = val;
      ...
      ymuint8 tmp2;
      s >> tmp2;
      CellVarType var_type2 = static_cast<CellVarType>(tmp2);
      ymuint8 n2;
      s >> n2;
  ...
  case 3:
	...
	index_array2[i] = val;
      ...
      ymuint8 tmp3;
      s >> tmp3;
      CellVarType var_type3 = static_cast<CellVarType>(tmp3);
      ymuint8 n3;
      s >> n3;
