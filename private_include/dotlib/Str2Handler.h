#ifndef STR2HANDLER_H
#define STR2HANDLER_H

/// @file Str2Handler.h
/// @brief Str2Handler のヘッダファイル
...
//////////////////////////////////////////////////////////////////////
/// @class Str2Str2Handler Str2Handler.h "dotlib/Str2Handler.h"
...
public:
  ...
  Str2Handler(DotlibParser& parser);
