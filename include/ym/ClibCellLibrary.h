...
public:
  ...
  virtual
  void
  set_technology(ClibTechnology technology) = 0;

  /// @brief 遅延モデルを設定する．
  /// @param[in] delay_model 遅延モデル．
  virtual
  void
  set_delay_model(ClibDelayModel delay_model) = 0;
  ...
  new_cell_input(ymuint cell_id,
		 ...
		 ClibCapacitance fall_capacitance) = 0;
  ...
  new_timing_generic(ymuint cell_id,
		     ...
		     ClibResistance fall_resistance) = 0;
  ...
  new_timing_piecewise(ymuint cell_id,
		       ...
		       ClibResistance fall_pin_resistance) = 0;
