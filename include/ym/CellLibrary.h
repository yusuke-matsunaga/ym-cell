#ifndef YM_CELLLIBRARY_H
#define YM_CELLLIBRARY_H

/// @file ym/CellLibrary.h
...
//////////////////////////////////////////////////////////////////////
/// @class CellLibrary CellLibrary.h "ym/CellLibrary.h"
/// @brief セルライブラリを表すクラス
//////////////////////////////////////////////////////////////////////
class CellLibrary
{
...
public:
  ...
  virtual
  void
  set_technology(CellTechnology technology) = 0;

  /// @brief 遅延モデルを設定する．
  /// @param[in] delay_model 遅延モデル．
  virtual
  void
  set_delay_model(CellDelayModel delay_model) = 0;
